      ...
      <div id="app">
        ...
        <Page label="cover">
          ...
          <p>
            ...
            little curlier than usual, we’ve got the solution. As a blend
            broker, you can access standard Accident and Health cover, or tailor
            a bespoke policy that’s particular to your clients’ circumstances.
            Have a flick through our products below, and get in touch when
            you’re ready to take the next step with us.
          </p>
          <div class="sections">
            <div class="section">
              <div class="icon" />
        ...
        <Page label="tech">
          ...
          <p>
            ...
            have preferred ways of working and distribution partners have their
            preferred approach to integration, so instead of disrupting that, we
            want to complement it so that every interaction you have with us is
            simple.
          </p>
        </Page>
        <Page label="contact">
